...
public class App {
	public static void main(final String[] args) {
		...
		alex.addFish(new Fish("Salmon", 15.0, "China",
			"ChiCO", Type.Sea, "Black Sea", "July14"));
		alex.addFish(new Fish("Cyprinys", 144.0, "UK",
			"UkInc.", Type.Sea, "North Sea", "June24"));
		alex.addFish(new Fish("Carassius", 9.0, "US",
			"MAFA2020", Type.FreshWater, "Hudson", "March12"));
